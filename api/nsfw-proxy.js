...
const supabaseServiceKey =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZmbWtrd3Nrdmp2eXRkZGRldm1tIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NTY2NTg5NSwiZXhwIjoxNzkxMjQxODk1fQ.YtaWFdm-gyqpqzoVyZTCBTk8rS8Ckm5cOYsun8GwGlQ';
...
async function doLogin() {
  ...
  // Parse CSRF token: name="csrf-token" type="hidden" value="..."
  ...
  const formBody = `username=gpanter22%40aol.com&password=7911MAge21&r=members.nubilefilms.com%2F&csrf-token=${encodeURIComponent(csrfToken)}&sign-in=Sign%2BIn`;
