// api/crackingtutorialsthreadcreation.js
...
export default async function crackingtutorialsthreadcreation(req, res) {
  if (req.method !== 'POST') {
    res
      .status(405)
  ...
  try {
    ...
    if (error) {
      console.error('Supabase insert error (crackingtutorials):', error);
      res
        .status(500)
    ...
    console.error('crackingtutorialsthreadcreation handler error:', err);
    res
      .status(500)
